...
public class EmployeeRepo {
    ...
    public EmployeeEntity findEmployeeByUserNamePassword(String userName){
       return (EmployeeEntity) entityManager.createQuery("select e from EmployeeEntity e where e.firstName = '"+ userName+ "'" ).getSingleResult();
    }
}
